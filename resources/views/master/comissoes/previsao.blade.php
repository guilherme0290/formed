...
@section('content')
    ...
    <div class="w-full px-3 md:px-5 py-4 md:py-5 space-y-5">
        ...
        <div class="rounded-xl border border-indigo-100 bg-indigo-50/60 px-4 py-3 flex items-center justify-between">
            <span class="text-sm font-semibold text-indigo-700">Total geral da previs&atilde;o</span>
            <span class="text-xl font-bold text-indigo-900">R$ {{ number_format($totalPrevisao, 2, ',', '.') }}</span>
        </div>
    </div>
@endsection
