        ...
        <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-orange-600 to-orange-700 text-white">
                ...
                <p class="text-xs text-white/80 mt-1">
                    Empresa: <span class="font-semibold">{{ $cliente->razao_social }}</span>
                </p>
            </div>
            ...
            <div class="p-6 space-y-4">
                ...
                {{-- Matriz --}}
                <a href="{{ route('operacional.ltcat.create', [$cliente, 'tipo' => 'matriz']) }}"
                ...
                {{-- Específico --}}
                <a href="{{ route('operacional.ltcat.create', [$cliente, 'tipo' => 'especifico']) }}"
