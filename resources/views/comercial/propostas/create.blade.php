                                ...
                                <div class="rounded-xl border border-slate-200 overflow-hidden">
                                    <div class="flex items-center justify-between px-3 py-2 bg-slate-50">
                                        ...
                                        <button type="button"
                                                ...
                                                onclick="openProtocolosModal({ clienteId: Number(document.querySelector('select[name=&quot;cliente_id&quot;]')?.value || 0) || null })">
                                            + Novo Grupo
                                        </button>
                                    </div>
        ...
        <script>
            (function () {
                ...
                function setCurrentGheFromSelect() {
                    ...
                    state.currentGhe = { cliente_ghe_id: null, ghe_id: ghe.id, ghe_nome: ghe.nome, _key: getGheConfigKey(ghe), tipos: {} };
